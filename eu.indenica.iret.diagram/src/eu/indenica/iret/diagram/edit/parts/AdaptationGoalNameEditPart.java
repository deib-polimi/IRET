 ...
 * @generated
 */
public class AdaptationGoalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AdaptationGoalNameEditPart(View view) {
		super(view);
	}
			...
			parser = IretParserProvider
					.getParser(
							...
							IretVisualIDRegistry
									.getType(eu.indenica.iret.diagram.edit.parts.AdaptationGoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}
