...
public class OperationCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		//Operation newElement = IretFactory.eINSTANCE.createOperation();
		Operation newElement;

		if (element != null)
			newElement = element;
		else
			newElement = IretFactory.eINSTANCE.createOperation();

		GoalDiagram owner = (GoalDiagram) getElementToEdit();
		owner.getIsViewOf().getContains().add(newElement);
//		owner.getHasOper().add(newElement);
