 ...
 * @generated
 */
public class EventItemSemanticEditPolicy extends IretBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public EventItemSemanticEditPolicy() {
		super(IretElementTypes.Event_2008);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (IretVisualIDRegistry.getVisualID(incomingLink) == OperationHasEventEditPart.VISUAL_ID) {
