 ...
 * @generated
 */
public class IretViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return GoalDiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = IretVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = IretVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!IretElementTypes.isKnownElementType(elementType)
		...
		return BehaviouralGoalEditPart.VISUAL_ID == visualID
				|| HumanAgentEditPart.VISUAL_ID == visualID
				|| AutomatedAgentEditPart.VISUAL_ID == visualID
				|| OperationEditPart.VISUAL_ID == visualID
				|| ANDRefinementLinkEditPart.VISUAL_ID == visualID
				|| ORRefinementLinkEditPart.VISUAL_ID == visualID
				|| EntityEditPart.VISUAL_ID == visualID
				|| EventEditPart.VISUAL_ID == visualID
				|| ContributionLinkEditPart.VISUAL_ID == visualID
				|| AdaptationGoalEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = IretVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != IretVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(GoalDiagramEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = IretVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = IretVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case BehaviouralGoalEditPart.VISUAL_ID:
			return createBehaviouralGoal_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case HumanAgentEditPart.VISUAL_ID:
			return createHumanAgent_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case AutomatedAgentEditPart.VISUAL_ID:
			return createAutomatedAgent_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case OperationEditPart.VISUAL_ID:
			return createOperation_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case ANDRefinementLinkEditPart.VISUAL_ID:
			return createANDRefinementLink_2005(domainElement, containerView,
					index, persisted, preferencesHint);
		case ORRefinementLinkEditPart.VISUAL_ID:
			return createORRefinementLink_2006(domainElement, containerView,
					index, persisted, preferencesHint);
		case EntityEditPart.VISUAL_ID:
			return createEntity_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case EventEditPart.VISUAL_ID:
			return createEvent_2008(domainElement, containerView, index,
					persisted, preferencesHint);
		case ContributionLinkEditPart.VISUAL_ID:
			return createContributionLink_2009(domainElement, containerView,
					index, persisted, preferencesHint);
		case AdaptationGoalEditPart.VISUAL_ID:
			return createAdaptationGoal_2010(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (IretVisualIDRegistry.getVisualID(elementTypeHint)) {
		case BehaviouralGoalOperationalizedByEditPart.VISUAL_ID:
			return createBehaviouralGoalOperationalizedBy_4001(containerView,
					index, persisted, preferencesHint);
		case AgentOperatEditPart.VISUAL_ID:
			return createAgentOperat_4002(containerView, index, persisted,
					preferencesHint);
		case RefinementLinkRefiningGoalsEditPart.VISUAL_ID:
			return createRefinementLinkRefiningGoals_4003(containerView, index,
					persisted, preferencesHint);
		case BehaviouralGoalRefinedByEditPart.VISUAL_ID:
			return createBehaviouralGoalRefinedBy_4019(containerView, index,
					persisted, preferencesHint);
		case ContributionLinkContributorEditPart.VISUAL_ID:
			return createContributionLinkContributor_4005(containerView, index,
					persisted, preferencesHint);
		case BehaviouralGoalContributedByEditPart.VISUAL_ID:
			return createBehaviouralGoalContributedBy_4006(containerView,
					index, persisted, preferencesHint);
		case AdaptationGoalHelpEditPart.VISUAL_ID:
			return createAdaptationGoalHelp_4007(containerView, index,
					persisted, preferencesHint);
		case OperationHasEventEditPart.VISUAL_ID:
			return createOperationHasEvent_4008(containerView, index,
					persisted, preferencesHint);
		case ObjectIsMonitoredByEditPart.VISUAL_ID:
			return createObjectIsMonitoredBy_4015(containerView, index,
					persisted, preferencesHint);
		case AgentControlsEditPart.VISUAL_ID:
			return createAgentControls_4010(containerView, index, persisted,
					preferencesHint);
		case EntityIsInputOfEditPart.VISUAL_ID:
			return createEntityIsInputOf_4014(containerView, index, persisted,
					preferencesHint);
		case OperationOutEditPart.VISUAL_ID:
			return createOperationOut_4012(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createBehaviouralGoal_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(IretVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createHumanAgent_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(IretVisualIDRegistry.getType(HumanAgentEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createAutomatedAgent_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createOperation_2004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(IretVisualIDRegistry.getType(OperationEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createANDRefinementLink_2005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createORRefinementLink_2006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	...
	public Node createEntity_2007(EObject domainElement, View containerView,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(IretVisualIDRegistry.getType(EntityEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createEvent_2008(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(IretVisualIDRegistry.getType(EventEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createContributionLink_2009(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createAdaptationGoal_2010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Edge createBehaviouralGoalOperationalizedBy_4001(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		edge.setType(IretVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createAgentOperat_4002(View containerView, int index,
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(IretVisualIDRegistry
				.getType(AgentOperatEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createRefinementLinkRefiningGoals_4003(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createBehaviouralGoalRefinedBy_4019(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createContributionLinkContributor_4005(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createBehaviouralGoalContributedBy_4006(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createAdaptationGoalHelp_4007(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createOperationHasEvent_4008(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createObjectIsMonitoredBy_4015(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createAgentControls_4010(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createEntityIsInputOf_4014(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createOperationOut_4012(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
