...
import eu.indenica.iret.diagram.edit.policies.AutomatedAgentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AutomatedAgentEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AutomatedAgentEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AutomatedAgentItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new AutomatedAgentFigure();
	}

	/**
	 * @generated
	 */
	public AutomatedAgentFigure getPrimaryShape() {
		return (AutomatedAgentFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AutomatedAgentNameEditPart) {
			((AutomatedAgentNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureAutomatedAgentNameFigure());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof eu.indenica.iret.diagram.edit.parts.AutomatedAgentEditPart) {
			types.add(IretElementTypes.ObjectIsMonitoredBy_4015);
		}
		if (targetEditPart instanceof HumanAgentEditPart) {
			types.add(IretElementTypes.AgentControls_4010);
	 ...
	 * @generated
	 */
	public class AutomatedAgentFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureAutomatedAgentNameFigure;

		/**
		 * @generated not
		 */
		public AutomatedAgentFigure() {
		...
		private void addNodeImage() {
			ImageDescriptor imgDesc = IretDiagramEditorPlugin
					.getBundledImageDescriptor("icons/big/automatedagent.png");
		...
		private void createContents() {
			...
			fFigureAutomatedAgentNameFigure = new WrappingLabel();

			fFigureAutomatedAgentNameFigure.setText("<...>");

			fFigureAutomatedAgentNameFigure
					.setFont(FFIGUREAUTOMATEDAGENTNAMEFIGURE_FONT);

			this.add(fFigureAutomatedAgentNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAutomatedAgentNameFigure() {
			return fFigureAutomatedAgentNameFigure;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREAUTOMATEDAGENTNAMEFIGURE_FONT = new Font(
