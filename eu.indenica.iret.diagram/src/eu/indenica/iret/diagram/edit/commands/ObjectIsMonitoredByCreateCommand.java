 ...
 * @generated
 */
public class ObjectIsMonitoredByCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ObjectIsMonitoredByCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return IretBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateObjectIsMonitoredBy_4015(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getIsMonitoredBy().add(getTarget());
		}
