...
import eu.indenica.iret.diagram.edit.policies.IretTextSelectionEditPolicy;
 ...
 * @generated
 */
public class BehaviouralGoalNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BehaviouralGoalNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new IretTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new GoalDiagramEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = IretParserProvider
					.getParser(
							IretElementTypes.BehaviouralGoal_2001,
							getParserElement(),
							IretVisualIDRegistry
									.getType(eu.indenica.iret.diagram.edit.parts.BehaviouralGoalNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					IretEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
