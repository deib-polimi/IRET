 ...
 * @generated
 */
public class ContributionLinkItemSemanticEditPolicy extends
		IretBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ContributionLinkItemSemanticEditPolicy() {
		super(IretElementTypes.ContributionLink_2009);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (IretVisualIDRegistry.getVisualID(incomingLink) == BehaviouralGoalContributedByEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (IretVisualIDRegistry.getVisualID(outgoingLink) == ContributionLinkContributorEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
