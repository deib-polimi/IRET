...
import eu.indenica.iret.diagram.edit.parts.IretEditPartFactory;
import eu.indenica.iret.diagram.part.IretVisualIDRegistry;

/**
 * @generated
 */
public class IretEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public IretEditPartProvider() {
		setFactory(new IretEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!GoalDiagramEditPart.MODEL_ID.equals(IretVisualIDRegistry
					.getModelID(view))) {
				return false;
			}
