...
/**
 * This is the item provider adapter for a {@link eu.indenica.iret.integration.easy.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EasyPackage.Literals.CONSTRAINT__EXPRESSION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Constraint.class)) {
			case EasyPackage.CONSTRAINT__EXPRESSION:
