 ...
 * @generated
 */
public class AutomatedAgentNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AutomatedAgentNameEditPart(View view) {
		super(view);
	}
			...
			parser = IretParserProvider
					.getParser(
							...
							IretVisualIDRegistry
									.getType(eu.indenica.iret.diagram.edit.parts.AutomatedAgentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
