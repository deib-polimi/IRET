...
import eu.indenica.iret.diagram.edit.policies.EventItemSemanticEditPolicy;
...
public class EventEditPart extends ShapeNodeEditPart {
	...
	public class EventFigure extends RectangleFigure {
		...
		private void addNodeImage() {
			...
			//					"/home/dani/workspace/eu.indenica.retool/images/event.png");
			//			ImageFigure imgF = new ImageFigure();
			//			imgF.setImage(img);
			ImageFigure imgF = new ImageFigure();
			ImageDescriptor imgDesc = IretDiagramEditorPlugin
					.getBundledImageDescriptor("icons/big/event.png");
		...
		private void createContents() {
			...
			fFigureEventNameFigure.setFont(FFIGUREEVENTNAMEFIGURE_FONT);
	 ...
	 * @generated
	 */
	static final Font FFIGUREEVENTNAMEFIGURE_FONT = new Font(
