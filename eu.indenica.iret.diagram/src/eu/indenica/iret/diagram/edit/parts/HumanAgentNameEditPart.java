 ...
 * @generated
 */
public class HumanAgentNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HumanAgentNameEditPart(View view) {
		super(view);
	}
			...
			parser = IretParserProvider
					.getParser(
							...
							IretVisualIDRegistry
									.getType(eu.indenica.iret.diagram.edit.parts.HumanAgentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
