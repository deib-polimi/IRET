...
import eu.indenica.iret.diagram.edit.policies.EntityItemSemanticEditPolicy;
...
public class EntityEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == IretElementTypes.AgentControls_4010) {
			types.add(IretElementTypes.HumanAgent_2002);
			types.add(IretElementTypes.AutomatedAgent_2003);
	...
	public class EntityFigure extends RectangleFigure {
		...
		private void addNodeImage() {
			...
			//					"/home/dani/workspace/eu.indenica.retool/images/entity.png");
			//			ImageFigure imgF = new ImageFigure();
			//			imgF.setImage(img);
			ImageFigure imgF = new ImageFigure();
			ImageDescriptor imgDesc = IretDiagramEditorPlugin
					.getBundledImageDescriptor("icons/big/entity.png");
