 ...
 * @generated
 */
public class IretElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public IretElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.IretElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "iret".equals(fileExtension) || ".iret".equals(fileExtension) || ".iret_diagram".equals(fileExtension) || "iret_diagram".equals(fileExtension); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	}
