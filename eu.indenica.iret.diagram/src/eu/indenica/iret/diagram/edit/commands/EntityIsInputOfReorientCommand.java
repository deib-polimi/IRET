 ...
 * @generated
 */
public class EntityIsInputOfReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EntityIsInputOfReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Operation && newEnd instanceof Entity)) {
			return false;
		}
		return IretBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEntityIsInputOf_4014(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return IretBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEntityIsInputOf_4014(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getIsInputOf().remove(getOldTarget());
		getNewSource().getIsInputOf().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getIsInputOf().remove(getOldTarget());
		getOldSource().getIsInputOf().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
