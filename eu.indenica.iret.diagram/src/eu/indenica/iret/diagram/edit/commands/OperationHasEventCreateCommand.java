 ...
 * @generated
 */
public class OperationHasEventCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OperationHasEventCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Event) {
			return false;
		}
		if (getSource() == null) {
		...
		return IretBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateOperationHasEvent_4008(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHasEvent().add(getTarget());
		}
