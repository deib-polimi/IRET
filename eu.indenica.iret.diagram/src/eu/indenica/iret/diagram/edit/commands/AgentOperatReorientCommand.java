 ...
 * @generated
 */
public class AgentOperatReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AgentOperatReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Operation && newEnd instanceof Agent)) {
			return false;
		}
		return IretBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAgentOperat_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return IretBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAgentOperat_4002(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getOperat().remove(getOldTarget());
		getNewSource().getOperat().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getOperat().remove(getOldTarget());
		getOldSource().getOperat().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
