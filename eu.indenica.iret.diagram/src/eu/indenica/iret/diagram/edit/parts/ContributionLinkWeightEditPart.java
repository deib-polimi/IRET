 ...
 * @generated
 */
public class ContributionLinkWeightEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ContributionLinkWeightEditPart(View view) {
		super(view);
	}
			...
			parser = IretParserProvider
					.getParser(
							...
							IretVisualIDRegistry
									.getType(eu.indenica.iret.diagram.edit.parts.ContributionLinkWeightEditPart.VISUAL_ID));
		}
		return parser;
	}
