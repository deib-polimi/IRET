 ...
 * @generated
 */
public class AgentControlsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AgentControlsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return IretBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateAgentControls_4010(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getControls().add(getTarget());
		}
